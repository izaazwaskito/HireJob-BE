...
module.exports = async (
  ...
  try {
    ...
    <div style="padding:20px">
      ...
      <p>
        We are delighted to offer you the position of ${hire_title} at ${rec_compname}. Your qualifications and experience have impressed us, and we believe you would be a valuable addition to our team.
      </p>
      <p>
        Position: ${hire_title}
      </p>
